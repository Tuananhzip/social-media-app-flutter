...
class AppColors {
  ...
  static const Color secondaryColor = Color(0xff0085FF);

  static const Color blueButtonAccentColor = Color(0xff0057FF);
  static const Color blueColor = Color(0xff8aceff);
  static const Color grayAccentColor = Color(0xFF424242);
